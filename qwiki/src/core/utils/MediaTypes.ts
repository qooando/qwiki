...
// reverse map
export var extensionMediaTypeMap: Map<string, string> = new Map<string, string>;
for (let [mimetype, extensions] of mediaTypeExtensionMap.entries()) {
    for (let extension of extensions) {
        extensionMediaTypeMap.set(extension, mimetype);
    }
}

export function getMediaTypeFromFilePath(name: string) {
    return extensionMediaTypeMap.get(name.split(".").pop())
};
