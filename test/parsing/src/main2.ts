...
//         term: "CODE_START",
//         regex: /\{\{/y,
//         onMatch: (ctx: lexicon.LexerContext) => {
...
//     {enable: enableIfIsCode, term: "SPACE", regex: /\s+/, onMatch: lexicon.onMatch.ignore},
//     {
//         enable: enableIfIsNotCode,
//         term: "TEXT",
//         regex: /(.(?!\{\{|}}))*./sy,
//         onMatch: lexicon.onMatch.concatSameTerm
//     }
// ];
//
// let _grammar = [
...
// ];
//
// let _rendering: render.RenderingRuleAsTuple[] = [
