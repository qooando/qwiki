...
export let grammarRules: grammar.Grammar = [
    ...
    ["foreach", "FOREACH GROUP_OPEN expr_assign_of GROUP_CLOSE separator branch END"],
    ...
    ["assign_operator", "EQ_ASSIGN | EQ_COALESCE | OF"],
    ["value", "variable | constant"],
    ["of_assign", "left_operand OF expression"],
